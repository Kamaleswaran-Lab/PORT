...
# All models trained with unweighted BCE for fair comparison
auroc = {
    "PORT":       [0.830, 0.826, 0.822, 0.829, 0.841],
    "BiLSTM":     [0.809, 0.817, 0.813, 0.814, 0.791],
    "XGB (MEDS)": [0.766, 0.768, 0.765, 0.758, 0.763],
    "LR (MEDS)":  [0.756, 0.755, 0.755, 0.762, 0.758],
}
auprc = {
    "PORT":       [0.132, 0.124, 0.127, 0.116, 0.145],
    "BiLSTM":     [0.101, 0.109, 0.108, 0.115, 0.100],
    "XGB (MEDS)": [0.093, 0.084, 0.085, 0.078, 0.081],
    "LR (MEDS)":  [0.091, 0.074, 0.064, 0.051, 0.046],
}

# Note: bootstrap 95% CIs across models and windows span ±0.021–0.027 AUROC
# and ±0.011–0.036 AUPRC at n_test=42,008. They are omitted from the plot for
# clarity since they are narrow relative to between-model differences and
...
def panel(ax, data, ylab, panel_letter, title, legend_loc, ylim, ci_by_model=None):
